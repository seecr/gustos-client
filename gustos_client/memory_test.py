...
#
# Copyright (C) 2012-2014, 2018, 2025-2026 Seecr (Seek You Too B.V.) https://seecr.nl
#
...
from gustos_client import Memory
...
class MemoryTest(SeecrTestCase):
    ...
    def test_meter_invalid_keys(self):
        self.assertRaises(ValueError, lambda: Memory(enabled=("free", "invalidkey")))
