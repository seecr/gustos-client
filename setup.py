...
majorVersion = '.'.join(version.split('.')[:2]) if '.' in version else version
...
setup(
    ...
    description='Gustos monitoring tool client.',
    long_description='Gustos monitoring tool client.',
    license='GPL',
    platforms='all',
)
